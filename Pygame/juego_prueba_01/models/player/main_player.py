...
class Jugador:
    def __init__(self, coord_x, coord_y, frame_rate = 100, speed_walk = 6, speed_run = 12, gravity = 16, jump = 32):
        ...
        self.__iddle_r = sf.get_surface_from_spritesheeet(r"Pygame\juego_prueba_01\assets\img\player\iddle\iddle.png", 7, 1)
        self.__iddle_l = sf.get_surface_from_spritesheeet(r"Pygame\juego_prueba_01\assets\img\player\iddle\iddle.png", 7, 1, flip = True)
        self.__walk_r = sf.get_surface_from_spritesheeet(r"Pygame\juego_prueba_01\assets\img\player\walk\walk.png", 8, 1)
        self.__walk_l = sf.get_surface_from_spritesheeet(r"Pygame\juego_prueba_01\assets\img\player\walk\walk.png", 8, 1, flip = True)
        self.__jump_r = sf.get_surface_from_spritesheeet(r"Pygame\juego_prueba_01\assets\img\player\jump\jump.png", 9, 1)
        self.__jump_l = sf.get_surface_from_spritesheeet(r"Pygame\juego_prueba_01\assets\img\player\jump\jump.png", 9, 1, flip = True)
        self.__run_r = sf.get_surface_from_spritesheeet(r"Pygame\juego_prueba_01\assets\img\player\run\run.png", 10, 1)
        self.__run_l = sf.get_surface_from_spritesheeet(r"Pygame\juego_prueba_01\assets\img\player\run\run.png", 10, 1, flip = True)
